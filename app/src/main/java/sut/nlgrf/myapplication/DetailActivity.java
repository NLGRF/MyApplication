...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView nameTextView, addressTextView, phoneTextView, genderTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Show Text
        Picasso.with(this).load(getIntent().getStringExtra("Image")).resize(200,200).into(imageView);
